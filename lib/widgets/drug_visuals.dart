...
extension DrugCategoryVisual on DrugCategory {
  ...
  Color get color => switch (this) {
    ...
    DrugCategory.inhalational => const Color(
      0xFFFFF0A8,
    ), // PMS 109系 : 吸入麻酔薬 (UI区別のため淡黄)
    DrugCategory.muscleRelaxant => const Color(
      0xFFEF3340,
    ), // PMS Red032: 筋弛緩薬 標準赤
    DrugCategory.analgesic => const Color(
      0xFF7EC8E3,
    ), // PMS 297   : 鎮痛薬/麻薬 ライトブルー
    DrugCategory.vasopressor => const Color(0xFFB39DDB), // 昇圧薬 : 淡い明るいバイオレット
    DrugCategory.vasodilator => const Color(
      0xFFB39DDB,
    ), // 降圧薬 : 淡い明るいバイオレット (+ 斜線)
    ...
    DrugCategory.anticoagulant => const Color(
      0xFFB52020,
    ), // 凝固系 : 血色 (blood red)
